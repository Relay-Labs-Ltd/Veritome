...
```mermaid
flowchart LR
  A[1 · Classify] --> B[2 · Scope &<br/>literacy]
  B --> C[3 · Build &<br/>document]
  C --> D[4 · Conformity<br/>assessment]
  D --> E[5 · Register]
  E --> F[6 · Operate &<br/>monitor]
  F -. reviews, alerts, incidents .-> A
```
...
<sub>© 2026 Relay Labs Ltd — Dublin. All rights reserved. Veritome is proprietary software; this overview is provided for information only and grants no rights to the software.</sub>
